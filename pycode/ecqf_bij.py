...
try:
    ...
    qf_ldata = {}     # not generated yet -> disc_ldata falls back to a live search
                      # (regenerate with: python rigid_cache.py --ldata --min -4096)
...
def ss_horizontal_nbr_data(p, ls, sigs):
    ...
    same-level signatures.  Odd l via the eigenline Velu walk (velu_nbr_data_ss_walk); l = 2 via
...
def ecqf_full_bijection_ss(p, ls=None):
    ...
    Case A (p = 1 mod 4): a signature analogue of the ordinary Z/n bijection (no volcano).
