...
State lives in query params (?p=..&l=..) so every graph is a shareable URL,
matching the Explorer. The picture is the canvas widget in explorer_viz:
Frobenius acts literally as the reflection across the horizontal axis.
"""
